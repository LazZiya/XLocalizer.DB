...
namespace XLocalizer.DB.EF
{
    ...
    public class EFDbResourceProviderFactory<TContext> : IDbResourceProvider
        where TContext : DbContext
    {
        ...
        /// <summary>
        /// Initialize a new instance of <see cref="EFDbResourceProviderFactory{TContext}"/>
        /// </summary>
        /// <param name="dbContextFactory"></param>
        /// <param name="logger"></param>
        public EFDbResourceProviderFactory(IDbContextFactory<TContext> dbContextFactory, ILogger<EFDbResourceProviderFactory<TContext>> logger)
        {
            ...
            where TResource : class, IXDbResource
        {
            ...
            var existed = dbContext.Set<TResource>().AsNoTracking().SingleOrDefault(x => x.Key == resource.Key && x.CultureID == resource.CultureID);
            ...
            {
                dbContext.Set<TResource>().Add(resource);
